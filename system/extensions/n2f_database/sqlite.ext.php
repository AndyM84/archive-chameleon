<?php
	...
	/*
	 * $Id: db.sqlite.ext.php 56 2009-12-23 20:34:50Z amale $
	 */
	...
	$strings['en']['SQLITEDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the SQLite database extension was invalid.';
	$strings['en']['SQLITEDB_ERROR_FAILED_DBACCESS']		= "The SQLite database extension was unable to access the '_%1%_' database for the following reason(s): _%2%_";
	$strings['en']['SQLITEDB_ERROR_FAILED_DBOPEN']		= "The SQLite database extension was unable to open for the following reason(s): _%1%_";
	$strings['en']['SQLITEDB_ERROR_FAILED_QUERY']		= 'Failed to execute a query. (_%1%_)';
	$strings['en']['SQLITE_ERROR_NO_QUERY']				= 'Operation performed on a non-query.';
	$strings['en']['SQLITEDB_ERROR_MISSING_SQLITE']		= 'The PHP SQLite extension is not installed on this system, aborting SQLite extension registration.';

	// German error strings
	$strings['de']['SQLITEDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the SQLite database extension was invalid.';
	$strings['de']['SQLITEDB_ERROR_FAILED_DBACCESS']		= "The SQLite database extension was unable to access the '_%1%_' database for the following reason(s): _%2%_";
	$strings['de']['SQLITEDB_ERROR_FAILED_DBOPEN']		= "The SQLite database extension was unable to open for the following reason(s): _%1%_";
	$strings['de']['SQLITEDB_ERROR_FAILED_QUERY']		= 'Failed to execute a query. (_%1%_)';
	$strings['de']['SQLITE_ERROR_NO_QUERY']				= 'Operation performed on a non-query.';
	$strings['de']['SQLITEDB_ERROR_MISSING_SQLITE']		= 'The PHP SQLite extension is not installed on this system, aborting SQLite extension registration.';

	// Spanish error strings
	$strings['es']['SQLITEDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the SQLite database extension was invalid.';
	$strings['es']['SQLITEDB_ERROR_FAILED_DBACCESS']		= "The SQLite database extension was unable to access the '_%1%_' database for the following reason(s): _%2%_";
	$strings['es']['SQLITEDB_ERROR_FAILED_DBOPEN']		= "The SQLite database extension was unable to open for the following reason(s): _%1%_";
	$strings['es']['SQLITEDB_ERROR_FAILED_QUERY']		= 'Failed to execute a query. (_%1%_)';
	$strings['es']['SQLITE_ERROR_NO_QUERY']				= 'Operation performed on a non-query.';
	$strings['es']['SQLITEDB_ERROR_MISSING_SQLITE']		= 'The PHP SQLite extension is not installed on this system, aborting SQLite extension registration.';

	// Swedish error strings
	$strings['se']['SQLITEDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the SQLite database extension was invalid.';
	$strings['se']['SQLITEDB_ERROR_FAILED_DBACCESS']		= "The SQLite database extension was unable to access the '_%1%_' database for the following reason(s): _%2%_";
	$strings['se']['SQLITEDB_ERROR_FAILED_DBOPEN']		= "The SQLite database extension was unable to open for the following reason(s): _%1%_";
	$strings['se']['SQLITEDB_ERROR_FAILED_QUERY']		= 'Failed to execute a query. (_%1%_)';
	$strings['se']['SQLITE_ERROR_NO_QUERY']				= 'Operation performed on a non-query.';
	$strings['se']['SQLITEDB_ERROR_MISSING_SQLITE']		= 'The PHP SQLite extension is not installed on this system, aborting SQLite extension registration.';
			...
			if ($db->isOpen()) {
				if (!sqlite_query($db->conn, "SELECT * FROM sqlite_master LIMIT 1")) {
					...
					if (!defined('SQLITEDB_CAN_CACHE')) {
						define('SQLITEDB_CAN_CACHE',		(bool)$n2f->hasExtension('cache'));
					}
				}
			} else {
				if ($n2f->debug->showLevel(N2F_DEBUG_ERROR)) {
