<?php
	...
	/*
	 * $Id: db.pgsql.ext.php 56 2009-12-23 20:34:50Z amale $
	 */
	...
	$strings['en']['PGSQLDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the PgSQL database extension was invalid.';
	$strings['en']['PGSQLDB_ERROR_FAILED_DBCONNECT']		= 'The PgSQL database extension was unable to connect for the following reason(s): _%1%_';
	$strings['en']['PGSQLDB_ERROR_FAILED_QUERY']			= 'Failed to execute a query. (ERROR: _%1%_) (QUERY: _%2%_)';
	$strings['en']['PGSQLDB_ERROR_NO_QUERY']			= 'The action could not be performed because no active query was found.';
	$strings['en']['PGSQLDB_ERROR_INVALID_RESULT']		= 'The result resource referenced was invalid.';
	$strings['en']['PGSQLDB_ERROR_MISSING_PGSQL']		= 'The PHP PgSQL extension is not installed on this system, aborting PgSQL extension registration.';
	$strings['en']['PGSQLDB_ERROR_FAILED_PARAMETER']		= 'A parameter failed to load for the following reason(s): _%1%_';

	// German error strings
	$strings['de']['PGSQLDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the PgSQL database extension was invalid.';
	$strings['de']['PGSQLDB_ERROR_FAILED_DBCONNECT']		= 'The PgSQL database extension was unable to connect for the following reason(s): _%1%_';
	$strings['de']['PGSQLDB_ERROR_FAILED_QUERY']			= 'Failed to execute a query. (ERROR: _%1%_) (QUERY: _%2%_)';
	$strings['de']['PGSQLDB_ERROR_NO_QUERY']			= 'The action could not be performed because no active query was found.';
	$strings['de']['PGSQLDB_ERROR_INVALID_RESULT']		= 'The result resource referenced was invalid.';
	$strings['de']['PGSQLDB_ERROR_MISSING_PGSQL']		= 'The PHP PgSQL extension is not installed on this system, aborting PgSQL extension registration.';
	$strings['de']['PGSQLDB_ERROR_FAILED_PARAMETER']		= 'A parameter failed to load for the following reason(s): _%1%_';

	// Spanish error strings
	$strings['es']['PGSQLDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the PgSQL database extension was invalid.';
	$strings['es']['PGSQLDB_ERROR_FAILED_DBCONNECT']		= 'The PgSQL database extension was unable to connect for the following reason(s): _%1%_';
	$strings['es']['PGSQLDB_ERROR_FAILED_QUERY']			= 'Failed to execute a query. (ERROR: _%1%_) (QUERY: _%2%_)';
	$strings['es']['PGSQLDB_ERROR_NO_QUERY']			= 'The action could not be performed because no active query was found.';
	$strings['es']['PGSQLDB_ERROR_INVALID_RESULT']		= 'The result resource referenced was invalid.';
	$strings['es']['PGSQLDB_ERROR_MISSING_PGSQL']		= 'The PHP PgSQL extension is not installed on this system, aborting PgSQL extension registration.';
	$strings['es']['PGSQLDB_ERROR_FAILED_PARAMETER']		= 'A parameter failed to load for the following reason(s): _%1%_';

	// Swedish error strings
	$strings['se']['PGSQLDB_ERROR_INVALID_CONFIG']		= 'The configuration submitted for the PgSQL database extension was invalid.';
	$strings['se']['PGSQLDB_ERROR_FAILED_DBCONNECT']		= 'The PgSQL database extension was unable to connect for the following reason(s): _%1%_';
	$strings['se']['PGSQLDB_ERROR_FAILED_QUERY']			= 'Failed to execute a query. (ERROR: _%1%_) (QUERY: _%2%_)';
	$strings['se']['PGSQLDB_ERROR_NO_QUERY']			= 'The action could not be performed because no active query was found.';
	$strings['se']['PGSQLDB_ERROR_INVALID_RESULT']		= 'The result resource referenced was invalid.';
	$strings['se']['PGSQLDB_ERROR_MISSING_PGSQL']		= 'The PHP PgSQL extension is not installed on this system, aborting PgSQL extension registration.';
	$strings['se']['PGSQLDB_ERROR_FAILED_PARAMETER']		= 'A parameter failed to load for the following reason(s): _%1%_';
	...
	function pgsql_openConnection(n2f_database &$db, n2f_cfg_db $cfg) {
		...
		if (!defined('PGSQLDB_CAN_CACHE')) {
			define('PGSQLDB_CAN_CACHE',		(bool)$n2f->hasExtension('cache'));
		}
