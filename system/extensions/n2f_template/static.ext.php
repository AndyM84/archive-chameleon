<?php
	...
	/*
	 * $Id: tpl.dynamic.ext.php 103 2010-07-10 08:42:58Z amale $
	 */

	// Pull/create the global variables needed
	global $strings, $_n2f_stattpl_aliases, $_n2f_stattpl_galiases, $_n2f_stattpl_gbindings;
	...
	$strings['en']['STATTPL_ERROR_INVALID_MODULE']		= "The requested module is invalid: '_%1%_'";
	$strings['en']['STATTPL_ERROR_TEMPLATE_NOT_FOUND']	= "The requested template was not found: '_%1%_'";

	// German error strings
	$strings['de']['STATTPL_ERROR_INVALID_MODULE']		= "The requested module is invalid: '_%1%_'";
	$strings['de']['STATTPL_ERROR_TEMPLATE_NOT_FOUND']	= "The requested template was not found: '_%1%_'";

	// Spanish error strings
	$strings['es']['STATTPL_ERROR_INVALID_MODULE']		= "The requested module is invalid: '_%1%_'";
	$strings['es']['STATTPL_ERROR_TEMPLATE_NOT_FOUND']	= "The requested template was not found: '_%1%_'";

	// Swedish error strings
	$strings['se']['STATTPL_ERROR_INVALID_MODULE']		= "The requested module is invalid: '_%1%_'";
	$strings['se']['STATTPL_ERROR_TEMPLATE_NOT_FOUND']	= "The requested template was not found: '_%1%_'";
		...
		public static function handle_render(n2f_template $tpl) {
			...
			if (!isset($tpl->module)) {
				...
				if (!$preChecked && !is_file($path)) {
					...
					if($n2f->hasExtension('cache') && !($flags & n2f_template_static::flag_cache_exempt)) {
